...
//
// Generated from index 'IDX_ActiveProbeConfig_active_probe_id'.
...
//
// Generated from index 'UNIQUE_ActiveProbeConfig_active_probe_id_target'.
...
func ActiveProbeConfigByID(db XODB, id int64) (*ActiveProbeConfig, error) {
	var err error
